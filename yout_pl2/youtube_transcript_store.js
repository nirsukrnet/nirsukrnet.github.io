(function(){
  ...
  async function save(videoId, items, rawText, meta) {
    const vid = cleanVideoId(videoId);
    ...
    if (meta && typeof meta === 'object') {
      const l1 = String(meta.lang1_show || '').trim();
      const l2 = String(meta.lang2_show || '').trim();
      if (l1) payload.lang1_show = l1;
      if (l2) payload.lang2_show = l2;
    }
